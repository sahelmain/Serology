...
const Simple_Faculty_QC_Review = () => {
  ...
  function handleQualitativeReportClick() {
    if (selectedRowData && selectedAnalyte) {
      navigate(`/serology/qualitative-report/${selectedRowData.fileName}/${selectedRowData.lotNumber}/${selectedAnalyte}`);
    }
  }
              ...
              <div>
                ...
                <div className="flex justify-center mt-6">
                  ...
                  <Button
                    variant="contained"
                    color="primary"
                    onClick={handleQualitativeReportClick}
                    disabled={!selectedAnalyte}
                    className="mr-4"
                  >
