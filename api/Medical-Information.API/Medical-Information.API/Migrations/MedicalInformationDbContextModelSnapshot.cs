            ...
            modelBuilder.Entity("Medical_Information.API.Models.Domain.AdminQCLot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FileDate = new DateTime(2024, 12, 8, 2, 52, 14, 403, DateTimeKind.Local).AddTicks(6489),
                            IsActive = false,
                            LotNumber = "888888888888",
                            OpenDate = new DateTime(2024, 12, 8, 2, 52, 14, 403, DateTimeKind.Local).AddTicks(6506),
                            QCName = "CMP Level I",
                            Qualitative = true
                        });
                });
            ...
            modelBuilder.Entity("Medical_Information.API.Models.Domain.Analyte", b =>
                {
                    ...
                    b.Property<string>("TiterMax")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TiterMin")
                        .HasColumnType("nvarchar(max)");
